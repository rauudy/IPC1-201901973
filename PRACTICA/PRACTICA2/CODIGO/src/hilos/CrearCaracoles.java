 ...
 * @author Raudy
 */
public class CrearCaracoles implements Runnable {
    ...
    public CrearCaracoles(int ancho, int alto, Color color, JPanel panelTablero, int velocidadCreacion, int velocidadMov) {
        this.ancho = ancho;
        this.alto = alto;
        this.color = color;
    ...
    public void run() {
        ...
        while (true) {
            ...
            JLabel lbl2;
            MoverLabel proceso1;
            lbl2 = Utiles.crearLabel(Utiles.rutaImagenCaracol, this.ancho, this.alto, 100 * random, 0, this.color);

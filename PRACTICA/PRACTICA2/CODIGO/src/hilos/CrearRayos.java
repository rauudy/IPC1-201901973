 ...
 * @author Raudy
 */
public class CrearRayos implements Runnable {
    ...
    public CrearRayos(int ancho, int alto, Color color, JPanel panelTablero, int velocidadCreacion, int velocidadMov) {
        this.ancho = ancho;
        this.alto = alto;
        this.color = color;
    ...
    public void run() {
        ...
        while (true) {
            ...
            JLabel lbl2;
            MoverLabel proceso1;
            lbl2 = Utiles.crearLabel(Utiles.rutaImagenRayo, this.ancho, this.alto, 100 * random, 0, this.color);

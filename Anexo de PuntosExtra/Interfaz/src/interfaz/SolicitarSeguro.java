...
public class SolicitarSeguro extends javax.swing.JFrame {
    String nombre,apellidos,dpi,telefono,valorVehiculo;
    //int dpi,telefono,valorVehiculo;
    ...
    private void jTextField2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField2ActionPerformed
        //String jTextField2ActionPerformed = this.apellidos;
        // TODO add your handling code here:
        //this.apellidos = this.jTextField2();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println(this.nombre=this.jTextField1.getText() );
        System.out.print("Apellido:");
        System.out.println(this.apellidos=this.jTextField2.getText() );
        System.out.print("DPI:");
        System.out.println(this.dpi=this.jTextField3.getText() );
        System.out.print("Telefono:");
        System.out.println(this.telefono=this.jTextField4.getText() );
        System.out.print("Valor del Vehiculo:");
        System.out.println(this.valorVehiculo=this.jTextField5.getText() );
    ...
    private String jTextField1ActionPerformed() {
